...
To install, add @"com.typesafe.play.plugins" %% "play-statsd" % "2.2.0"@ to your dependencies, for example:

bc.. val appDendencies = Seq(@"com.typesafe.play.plugins" %% "play-statsd" % "2.2.0")
